                ...
                try:
                    ...
                    for attempt in range(max_retries):
                        try:
                            ...
                            summary_text, original_text = summarizer.summarize_document(document.pdf_url, language=lang)
                            logger.debug(f"Summary generated: {summary_text[:100]}...")
                            logger.debug(f"Original text: {original_text[:100] if original_text else 'None'}...")
                            break
...
#                             summary_text, _ = summarizer.summarize_document(document.pdf_url, language=lang)
#                             break
#                         except Exception as e:
#                             if attempt == max_retries - 1:
